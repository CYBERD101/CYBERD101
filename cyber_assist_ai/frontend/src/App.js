  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      if (followerRef.current) {
        // Performance: Use translate3d for hardware acceleration and bypass React state updates
...
function App() {
  ...
  // Performance: Memoize themeColor to prevent unnecessary re-renders of child components
